...
### Ejemplo forma de representación caso de uso
<table>
<tr>
<td>Servicio:</td>
<td>Login</td>
...
<tr>
<td>Descripción:</td>
<td>Permite autenticarnos ante el API, para lo cual es necesario mandar las credenciales user/password y como respuesta, retornará el Token generado.</td>
</tr>
<tr>
<td>Ruta</td>
<td>/login</td>
...
Ok: valor booleano que indica si la operación fue exitosa.<br/>
body: contiene los datos del usuario.<br/>
